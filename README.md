...
<table>
  ...
  <body>
    ...
    <tr>
      ...
      <td>
        <b>a)</b> Employee and department data will be read from the database via Redis (see <a href="https://github.com/ozmen54/SWE307-2025/blob/main/pro-1.png">Figure 1</a>). Implement CRUD operations on emp table of scott database. <br>
        <b>b)</b> Employee images will be fetched from HDFS (use these <a href="https://github.com/ozmen54/SWE307-2025/images">example image files</a>).<br>
