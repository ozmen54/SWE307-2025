  ...
  <body>
    <tr>
      ...
      <td>
        ...
        <b>b)</b> Groups will use the attached CSV file as data source <a href="https://github.com/ozmen54/SWE307-2023/tree/main/Pro1/data">CSV files</a>. Use only one column in this study, such as first group will use only *Col-1* data. There are 100 rows (100 data) in the file, and this file will be opened, read by Java not R.<br>
